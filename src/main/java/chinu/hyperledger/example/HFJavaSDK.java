package chinu.hyperledger.example;
 ...
 * @author chinu
 */
public class HFJavaSDK {

    private static final Logger log = Logger.getLogger(HFJavaSDK.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        AppUser appUser = getUser(caClient, admin, "huser");
        log.info(appUser);
